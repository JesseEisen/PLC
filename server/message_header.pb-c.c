...
const ProtobufCEnumValue message_header__type__enum_values_by_number[3] =
{
  ...
  { "RESPONES", "MESSAGE_HEADER__TYPE__RESPONES", 2 },
...
static const ProtobufCFieldDescriptor message_header__field_descriptors[5] =
{
  {
    "Message_ID",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(MessageHeader, has_message_type),
    PROTOBUF_C_OFFSETOF(MessageHeader, message_type),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    PROTOBUF_C_OFFSETOF(MessageHeader, has_room_tag),
    PROTOBUF_C_OFFSETOF(MessageHeader, room_tag),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
